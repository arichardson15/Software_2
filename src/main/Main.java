...
public class Main extends Application {
    ...
    public static void main(String[] args) {
       ...
       Schedule.addCustomer(customer2);
        ...
        Appointment appointment1 = new Appointment((Schedule.assignAppointmentId()), "title", "description", "location", "contact", "type", 34.34, 12323, 23.34, 23, (Schedule.assignCustomerId()), 34);
